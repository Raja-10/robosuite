...
if __name__ == "__main__":
    ...
    if args.device == "keyboard":
        ...
        from robosuite.devices.joystick import Joystick
        device = Joystick(env=env, pos_sensitivity=args.pos_sensitivity, rot_sensitivity=args.rot_sensitivity)
    
    elif args.device == "hardware_teleop":
        from robosuite.devices.nero_hardware_teleop import NeroHardwareTeleop
        device = NeroHardwareTeleop(env=env, pos_sensitivity=args.pos_sensitivity, rot_sensitivity=args.rot_sensitivity)
