...
from robosuite.environments.manipulation.shape_peg_insertion import ShapePegInsertion
from robosuite.environments.manipulation.colorful_cube_stack import ColorfulCubeStack
